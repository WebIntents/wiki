...
serve: .tmp/blobstore
	dev_appserver.py --require_indexes --enable_sendmail --use_sqlite --blobstore_path=.tmp/blobstore --datastore_path=.tmp/datastore --skip_sdk_update_check -d -a 0.0.0.0 .
